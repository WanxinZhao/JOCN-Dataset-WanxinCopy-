/*
 * Three-RAT implementation and bounded-sweep executable.
 *
...
// so that the source remains project-local without changing the legacy
// ns-3 build graph.
...
main(int argc, char* argv[])
{
    ...
    std::string outputDir = "./three-rat-output";
